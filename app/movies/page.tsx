...
import { RecentMovies } from "@/app/movies/components/RecentMovies";
import { TrendingMovies } from "@/app/movies/components/TrendingMovies";
  ...
  return (
    <div>
      ...
      <main className="max-w-6xl mx-auto">
        <div>
          <Button variant="ghost" className="mr-1 cursor-">
            Filmes
          </Button>
          <a href="/series">
